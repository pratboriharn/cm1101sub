...
def main():
    ...
    while True:
        ...
        display_room(current_room)# Display game status (room description etc.)

        
        exits = current_room["exits"]# What are the possible exits from the current room?

        
        direction = menu(exits)# Show the menu with exits and ask the player

        
        current_room = move(exits, direction)# Move the protagonist, i.e. update the current room
